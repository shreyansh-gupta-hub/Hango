(() => {
    var e = {
            ...
            4345: function(e, t, i) {
                ...
                n.define("slider", e.exports = function(e, t) {
                    ...
                    function g() {
                        (i = f.find(h)).length && (i.each(b), d || (y(), n.resize.on(w), n.redraw.on(l.redraw)))
                    }
                    ...
                    function C(i) {
                        return function(a, o) {
                            ...
                            if (s && "setting" === a.type) {
                                ...
                                return d = o.select, l = null, d === i.slides.length && (g(), P(i)), t.each(i.anchors, function(t, i) {
                    ...
                    function S(t, i) {
                        ...
                        var r = i.index,
                            d = {};
                        r < 0 ? (r = a.length - 1, n.infinite && (d.x = -t.endX, d.from = 0, d.to = a[0].width)) : r >= a.length && (r = 0, n.infinite && (d.x = a[a.length - 1].width, d.from = -a[a.length - 1].x, d.to = d.from - d.x)), t.index = r;
                        ...
                        var f = t.offsetX || 0,
                            ...
                            O = "opacity " + x + "ms " + b,
                            E = "transform " + x + "ms " + b;
                        if (p.find(o).removeAttr("tabindex"), p.removeAttr("aria-hidden"), p.find("*").removeAttr("aria-hidden"), y.find(o).attr("tabindex", "-1"), y.attr("aria-hidden", "true"), y.find("*").attr("aria-hidden", "true"), s || (p.each(v.intro), y.each(v.outro)), i.immediate && !m) {
                            c(p).set(h), L();
                            return
                        }
                        if (t.index !== t.previous) {
                            if (s || t.ariaLiveLabel.text(`Slide ${r+1} of ${a.length}.`), "cross" === w) {
                    ...
                    function j(t, i) {
                        ...
                        if (d) {
                            if (a = (n = d).mask.width(), n.maskWidth !== a && (n.maskWidth = a, 1)) return P(d);
                            s && (o = 0, (r = d).slides.each(function(t, i) {
                                o += e(i).outerWidth(!0)
                            }), r.slidesWidth !== o && (r.slidesWidth = o, 1)) && P(d)
                        }
                    }
            ...
            994: function(e, t, i) {
                i(9461), i(7624), i(286), i(8334), i(2338), i(3695), i(322), i(941), i(5134), i(1655), i(9858), i(2444), i(9904), i(1724), i(4345), i(9078), i(7527), i(1260)
            }
        },
        t = {};
    ...
    var n = i.O(void 0, ["910", "90", "729", "471"], function() {
        return i(994)
    });
    n = i.O(n)
})();