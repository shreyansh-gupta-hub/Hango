            ...
            if (a.source === U) {
                ...
                if (!(!a.widgetId || !m.widgetMap.has(a.widgetId))) {
                    ...
                    if (!(!i || !r)) switch (a.event) {
                        case "init":
                            {
                                var u;r.widgetInitStartTimeTsMs = j();
                                ...
                                s.style.display = "";
                                var h = r.shadow.querySelector("#".concat(i));h || v("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                        ...
                        case "translationInit":
                            {
                                ...
                                var E = new Map;r.displayLanguage = a.displayLanguage,
                        ...
                        case "requestFeedbackData":
                            {
                                var te, se = r.shadow.querySelector("#".concat(i));se || v("Received state for an unknown widget: #".concat(i, " / ").concat(a.widgetId), 3078),
                        ...
                        case "turnstileResults":
                            {
                                var be, q, de = (be = r.wrapper.parentNode) === null || be === void 0 ? void 0 : be.querySelector("#".concat(i, "-fr"));de || v("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                        ...
                        case "closeFeedbackReportIframe":
                            {
                                var re, xe = (re = r.wrapper.parentNode) === null || re === void 0 ? void 0 : re.querySelector("#".concat(i, "-fr"));xe || v("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                mr("".concat(i, "-fr"));
                                break
                            }
                        case "tokenExpired":
                            {
                                var ne, we = a.token;r.isExpired = !0,
                        ...
                        case "requestExtraParams":
                            {
                                ...
                                var Se = r.shadow.querySelector("#".concat(i));Se || v("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                r.isResetting = !1;
                                var ie = {},
                                    Ke = j(),
                                    Ae = {
